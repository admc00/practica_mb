...
public class jfrmPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        barraBuscador = new javax.swing.JTextField();
        botonBuscar = new javax.swing.JButton();
        jScrollPane1 = new javax.swing.JScrollPane();
        ResultadosBusqueda = new javax.swing.JTextPane();
        jLabel3 = new javax.swing.JLabel();
        Resultados = new javax.swing.JSpinner();
        ...
        barraBuscador.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                barraBuscadorActionPerformed(evt);
            }
        });
        ...
        jLabel3.setText("Nº Resultados");

        Campos.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "id", "title", "author", "text" }));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(barraBuscador, javax.swing.GroupLayout.PREFERRED_SIZE, 219, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jLabel2)
                    .addComponent(barraBuscador, javax.swing.GroupLayout.PREFERRED_SIZE, 22, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void botonBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonBuscarActionPerformed
        ...
        ResultadosBusqueda.setContentType("text/html");
        ...
        query.setQuery(Campos.getSelectedItem() + ":" + barraBuscador.getText());
        //solrQuery.setSort("id", ORDER.asc);
        query.setRows((Integer) Resultados.getValue());
        query.setFields("title,author,text");
        ...
        if (rsp != null) {
            ...
            for (int i = 0; i < docs.size(); i++) {
                System.out.println(docs.get(i).toString());
                    ...
                    resultados
                        += "<b>" + docs.get(i).get("title").toString().replace("[", "").replace("]", "") + "<br></b>"
                        + docs.get(i).get("author").toString().replace("[", "").replace("]", "") +"<br>"
                        + "<p>" + docs.get(i).get("text").toString() + "</p><br>";
            }
            ResultadosBusqueda.setText(resultados);
            if (docs.size() == 0) {
                JOptionPane.showMessageDialog(null, "NO SE HAN OBTENIDO RESULTADOS PARA TU CONSULTA");
            }
        }
    ...
    private void barraBuscadorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_barraBuscadorActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_barraBuscadorActionPerformed
    ...
    public javax.swing.JComboBox<String> Campos;
    public javax.swing.JSpinner Resultados;
    public javax.swing.JTextPane ResultadosBusqueda;
    private javax.swing.JTextField barraBuscador;
